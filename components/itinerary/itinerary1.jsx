...
export default function TravelItinerary() {
  ...
  const itineraryData = [
    ...
    },
    {
      ...
      description:
        "Visit the stunning temples of Thailand and enjoy a relaxing river cruise.",
      highlight: false,
    },
    {
      title: "Massage & Overnight Train (1 hour)",
      description:
        "Experience traditional Thai massage and travel on an overnight train.",
      highlight: false,
    },
    {
      title: "Khao Sok National Park (40 minutes)",
      description:
        "Explore the beautiful landscapes of Khao Sok National Park.",
      highlight: false,
    },
    {
    ...
    <div className="mt-6">
      <div className="relative overflow-hidden max-w-[80%]">
        ...
        {itineraryData.map((day, index) => (
          <div
            key={index}
            className="pl-10 pt-10 relative flex mb-2 last:mb-0 justify-center"
          >
            {/* Circle marker */}
            ...
            <div className="flex-1 pb-4 items-start">
              <div className="fw-500 mb-2">{day.title}</div>
