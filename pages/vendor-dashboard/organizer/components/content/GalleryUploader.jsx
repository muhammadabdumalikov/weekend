...
const GalleryUploader = () => {
  ...
  return (
    <div className="row x-gap-20 y-gap-20 pt-15">
      <div className="col-auto d-flex x-gap-20">
        <div className="w-200">
        ...
        <div className="w-200">
          ...
          />
          <div className="text-start mt-10 text-14 text-light-1">
            PNG or JPG no bigger than 360px wide and tall.
          </div>
        </div>
        <div className="w-200">
          <label htmlFor="uploadGallery" className="d-flex ratio ratio-1:1">
          ...
          />
          <div className="text-start mt-10 text-14 text-light-1">
            PNG or JPG no bigger than 768px wide and tall.
          </div>
        </div>
        <div className="w-200">
          <label htmlFor="uploadGallery" className="d-flex ratio ratio-1:1">
          ...
          />
          <div className="text-start mt-10 text-14 text-light-1">
            PNG or JPG no bigger than 1920px wide and tall.
          </div>
        </div>
      </div>
      {/* End uploader field */}
